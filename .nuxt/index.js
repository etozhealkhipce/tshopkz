...
import nuxt_plugin_range_339c50f2 from 'nuxt_plugin_range_339c50f2' // Source: ..\\plugins\\range (mode: 'client')
...
async function createApp (ssrContext) {
  ...
  const app = {
    head: {"title":"tshop","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Продажа игровых компьютеров в Казахстане"},{"name":"keywords","content":"Интернет—магазин, компьютеры, игровые аксессуары"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (process.client && typeof nuxt_plugin_vuescrollto_62b3aa20 === 'function') {
    await nuxt_plugin_vuescrollto_62b3aa20(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_3aafb7c9 === 'function') {
  ...
  if (process.client && typeof nuxt_plugin_range_339c50f2 === 'function') {
    await nuxt_plugin_range_339c50f2(app.context, inject)
  }

  if (typeof nuxt_plugin_plugin_05beecb8 === 'function') {
    await nuxt_plugin_plugin_05beecb8(app.context, inject)
  }
